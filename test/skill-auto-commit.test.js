...
// tests ejercitan el comportamiento productivo del hook a través del CLI
// (spawnSync) tras el fix D-14 de Plan 03.
 ...
 *
 * @param {{ tmpHome: string, tmpRepo: string, sessionId: string }} args
