...
Plans:
- [ ] 39.1-01-PLAN.md — TUI-17: eliminar el código muerto del wiring host (index.js/App.js/SessionTable.js + test)
- [ ] 39.1-02-PLAN.md — TUI-13/14: fuente única de `alive` (quitar override legacy en GET /status)
- [ ] 39.1-03-PLAN.md — TUI-10: `statusColor` v3-aware (deriva del estado v3 reusando STATE_BADGES)
- [ ] 39.1-04-PLAN.md — TUI-15: overlay de comentarios distingue unsupported vs vacío (campo aditivo `supported`)
- [ ] 39.1-05-PLAN.md — Bookkeeping D-10: reconciliar REQUIREMENTS.md (TUI-15/16 [x], traceability Status)
