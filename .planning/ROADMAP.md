...
- [x] **Phase 13: Test Coverage Matrix** — los 4 estados de label (none, gsd, gsd-quick, ambos) cubiertos en `labels`, `manager`, `dispatcher`, `session-start` (completed 2026-04-29)
