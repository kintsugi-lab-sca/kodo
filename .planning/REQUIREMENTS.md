...
- [ ] **PROJ-02**: El operador puede asignar o editar la ruta local de un proyecto; la ruta se valida (debe existir) antes de aceptarse.
- [ ] **PROJ-03**: El operador puede quitar el mapeo de un proyecto (dejarlo sin seguir) desde el editor.
- [ ] **PROJ-04**: El operador puede mapear carpetas de módulos independientes de un proyecto (opcional), espejo del soporte de módulos del wizard.
