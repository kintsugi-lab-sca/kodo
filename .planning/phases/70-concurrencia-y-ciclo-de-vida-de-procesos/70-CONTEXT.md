...
- **D-10:** El PID se escribe **post-bind** (después de que el server abra el puerto con éxito), no antes: si el bind falla, no queda un `kodo.pid` mintiendo sobre un proceso que nunca escuchó.
