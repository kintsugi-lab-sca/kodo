...
- [x] **Phase 68: Dashboard Setup Mode + CFGF-03 + First-Run** - primer arranque sin config → dashboard en modo setup (sin `exit(1)`) + edición provider/base_url/workspace_slug → `config.json` + `kodo config` rewired al mismo writer — SETUP-01, SETUP-02, SETUP-05 (completed 2026-07-03)
