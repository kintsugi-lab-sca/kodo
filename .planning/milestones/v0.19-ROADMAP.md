...
- [x] **Phase 84: Superficies de captura — skill, sync, conteo ambient** - `/kodo-capture` mid-session + `kodo skill sync` multi-skill + conteo de capturas sin enrutar en el dashboard — CAPT-02, CAPT-05, CAPT-07 (completed 2026-07-26)
- [x] **Phase 85: Saneo de deuda + Nyquist retroactivo** - Deuda doc de v0.18 (WR-01/WR-02, 80-REVIEW) + Nyquist retroactivo de 79/80/81 y 69/71/72 — DEBT-05..07, NYQ-01, NYQ-02 (completed 2026-07-28)
...
- [x] 83-07-PLAN.md — GAP-3: tag legible con la forma real de `projects.json`, saneo del carril `--json`, mapeo del fallo por escritura concurrente y copy corregida del seam (CAPT-01, CAPT-03, CAPT-04, CAPT-06) [wave 4]
...
- [x] 84-03-PLAN.md — conteo ambient de capturas sin enrutar: leaf never-throws anclado a `listCaptures` + cabecera del dashboard (CAPT-07) · wave 1
...
- [x] 85-03-PLAN.md — backfill Nyquist citation-based de las Phases 79/80/81 (NYQ-01) · wave 1
- [x] 85-04-PLAN.md — backfill Nyquist citation-based de las Phases 69/71/72, con 72 presupuestada aparte (NYQ-02) · wave 1
